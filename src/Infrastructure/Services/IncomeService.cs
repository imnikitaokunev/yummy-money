...
namespace Infrastructure.Services
{
    public class IncomeService : IIncomeService
    {
        ...
        public async Task<List<IncomeWithCategoryDto>> GetWithCategoryAsync(GetIncomesRequest request)
        {
            var incomes = await _incomeRepository.GetWithCategoryAsync(request);
            return _mapper.Map<List<IncomeWithCategoryDto>>(incomes);
        }
